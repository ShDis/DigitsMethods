#Определите число узлов для нахождения значения интеграла с точностью = 10^-3 по формулам Симпсона. Вычислите с данной точностью.
...
def adaptive_simpson(f, a, b, eps):
    """Вычисляет интеграл функции f на интервале [a, b] с заданной точностью eps с помощью адаптивной формулы Симпсона.
